        ...
        <div className="container py-8 md:py-12">
          <div className="mb-8 space-y-4">
            ...
            <p className="text-muted-foreground">
              Latest articles, tutorials, and resources to help you learn and grow.
            </p>
          </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-[1fr_2fr]">
                      <div className="relative aspect-video overflow-hidden md:aspect-square">
                        <Image
                          src={
                            post.image_url ||
                            `/placeholder.svg?height=300&width=300&text=${encodeURIComponent(post.title)}`
                          }
                          alt={post.title}
                          fill
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-2">
                  <Link href="/blog?category=Technology" className="block text-sm hover:text-primary">
                    Technology
                  </Link>
                  <Link href="/blog?category=Learning+Tips" className="block text-sm hover:text-primary">
                    Learning Tips
                  </Link>
                  <Link href="/blog?category=Data+Science" className="block text-sm hover:text-primary">
                    Data Science
                  </Link>
                </CardContent>
              </Card>
